...
class ChatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadBatch = channel.stream_unary(
                '/chat.v1.ChatService/UploadBatch',
                request_serializer=chat__pb2.SubscribeRequest.SerializeToString,
                response_deserializer=chat__pb2.UploadSummary.FromString,
                _registered_method=True)
...
def add_ChatServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadBatch': grpc.stream_unary_rpc_method_handler(
                    ...
                    response_serializer=chat__pb2.UploadSummary.SerializeToString,
            ),
...
class ChatService(object):
    ...
    @staticmethod
    def UploadBatch(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.stream_unary(
            ...
            chat__pb2.UploadSummary.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
